# DEFINE.prompt.md — Master Portfolio Prompt

Single copy/paste prompt. Fill the placeholders, paste into your AI tool of choice, iterate.

---

**Need a style anchor first?** Skim [`examples/beginner-example/`](./examples/beginner-example/) and [`examples/advanced-example/`](./examples/advanced-example/).

## The Prompt

```
You are an expert project portfolio designer and full-stack developer. Ask me questions to help me fill out as much information as possible fast to align on the job to be done.
